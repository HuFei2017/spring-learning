 ...
 * @Version 1.0
 */
public class ColorInput extends TextComponent {
    ...
    @Override
    public ColorInput withId(String id) {
        config.setId(id);
    ...
    @Override
    public ColorInput withName(String name) {
        config.setName(name);
    ...
    @Override
    public ColorInput withTitleColor(String titleColor) {
    ...
    @Override
    public ColorInput withMulti(int multi) {
        config.setMulti(multi);
        paramMap.put("withMulti", new Object[]{multi});
        return this;
    }

    public ColorInput withDefaultValue(String value) {
    ...
    @Override
    public ColorInput withHelp(String help) {
        config.setHelp(help);
    ...
    @Override
    public ColorInput withTooltip(String tooltip) {
    ...
    @Override
    public ColorInput withLineFeed() {
        config.setBr(true);
        paramMap.put("withLineFeed", new Object[0]);
        return this;
    }

    public ColorInput withDisabled() {
        config.setDisabled(true);
        paramMap.put("withDisabled", new Object[0]);
        return this;
    }

    public ColorInput withHidden() {
    ...
    @Override
    public ColorInput withNotRequireCondition(String notRequireCondition) {
    ...
    @Override
    public ColorInput withShowCondition(String showCondition) {
    ...
    @Override
    public ColorInput withHiddenCondition(String hiddenCondition) {
    ...
    @Override
    public ColorInput withDisableCondition(String disableCondition) {
        config.setDisableCondition(disableCondition);
        paramMap.put("withDisableCondition", new Object[]{disableCondition});
        return this;
    }

    public ColorInput withExpScript(String expScript) {
        super.setExpScript(expScript);
        return this;
    }

    public ColorInput withExpMsg(String expMsg) {
    ...
    @Override
    public ColorInput copy() {
        ColorInput result = new ColorInput();
